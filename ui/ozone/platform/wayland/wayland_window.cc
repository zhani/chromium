...
void WaylandWindow::CreateTooltipSubSurface() {
  ...
  tooltip_subsurface_.reset(wl_subcompositor_get_subsurface(subcompositor,
      surface_.get(), parent_window_->surface()));

  wl_subsurface_set_position(tooltip_subsurface_.get(), bounds_.x(), bounds_.y());
